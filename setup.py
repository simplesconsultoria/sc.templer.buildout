...
setup(
    ...
    buildout_base = sc.templer.buildout.template:Buildout
    buildout_frontend = sc.templer.buildout.template:FrontEndBuildout
    buildout_plone = sc.templer.buildout.template:PloneBuildout
